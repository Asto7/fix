...
def findmedian(image,boxes,size) :
    ...
    for corner in boxes:
        ...
        '''
            ...
            of each of them
        '''
        for yval in range(int(corner['topy']),int(corner['topy']+size)):
                for xval in range(int(corner['topx']),int(corner['topx']+size)):
                    red.append(image[int(xval)][int(yval)][0])
                    green.append(image[int(xval)][int(yval)][1])
                    blue.append(image[int(xval)][int(yval)][2])
        '''
